...
Users can change the date for which to display graphs. The default value is today's date. A dataframe is constructed for data on the chosen date, summing the steps per hour. This is shown on a plotly graph.
